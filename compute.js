...
function compute_password(name, pwd, token) {
    return base64encode(SHA256(name + base64encode(SHA256(pwd)) + token));
}
...
//
// Usage:
//   $ node compute.js NAME PASSWORD TOKEN
//
// Output:
//   a mangled string to be passed to the WebCube4 login API
...
//console.log(pwd);
//console.log(token);
console.log(compute_password(name, pwd, token));
//
// ===========================================================================
